...
var Game = {
    ...
    update: function () {
        ...
        // Check to see if the ai/AI has won the round.
            ...
            this.over = true;
            setTimeout(function () { Pong.endGameMenu('GAME OVER! Tente novamente...'); }, 1000);
        }
    },
...
// Obtendo o nome de usuário salvo no localStorage
const storedUsername = localStorage.getItem('username');

// Exibe o nome de usuário no canto superior direito
if (storedUsername) {
    const userDisplay = document.getElementById('user-display');
    userDisplay.textContent = `Usuário: ${storedUsername}`;
}
